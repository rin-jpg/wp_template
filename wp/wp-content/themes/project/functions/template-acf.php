...
// ファイルの拡張子を取得
if( ! function_exists( 'my_get_file_extension' ) ){
  function my_get_file_extension($field_name, $sub = null){
    if( $sub === true ){
...
// ファイルサイズ取得
if( ! function_exists( 'my_get_file_size' ) ){
  function my_get_file_size($field_name, $sub = null){
    if( $sub === true ){
